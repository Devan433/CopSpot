export default function Header() {
  return (
    <div className="absolute top-4 md:-top-6 left-1/2 -translate-x-1/2 z-20 pointer-events-none">
      <div className="bg-[var(--color-rp-bg)] border-[4px] md:border-[6px] border-[var(--color-rp-bezel-border)] rounded-full px-4 md:px-6 py-1 md:py-2 flex items-center shadow-[0_4px_0_0_#000] pointer-events-auto">
