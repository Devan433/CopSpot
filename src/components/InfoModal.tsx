export default function InfoModal({ onClose }: { onClose: () => void }) {
  return (
    <div className="fixed inset-0 z-[1000] flex items-end sm:items-center justify-center bg-black/60 backdrop-blur-sm p-0 sm:p-4">
      ...
      <div className="modal-frame w-full sm:max-w-md max-h-[85vh] flex flex-col rounded-t-2xl sm:rounded-2xl">
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="px-5 pb-2 space-y-4 text-sm text-[var(--color-cs-text-muted)]">
            <p>
          ...
          <div className="p-5">
            <button
              onClick={onClose}
              className="w-full py-3.5 font-semibold text-sm transition-all flex items-center justify-center rounded-xl bg-white text-[var(--color-cs-base)] hover:bg-gray-100 active:bg-gray-200 min-h-[44px]"
            >
              Got it
            </button>
          </div>
