export default function RadarSweep({ onClick }: { onClick?: () => void }) {
  return (
    <div onClick={onClick} className="absolute bottom-8 right-8 z-10 w-24 h-24 rounded-full border-2 border-[#14375b] bg-transparent flex items-center justify-center overflow-hidden pointer-events-auto cursor-pointer hidden md:flex hover:scale-105 transition-transform">
